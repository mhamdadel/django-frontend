        ...
        <div className="container py-5 min-h-screen">
            <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col-lg-10 col-xl-8">
                    <h2 className="text-muted text-center pt-4">Track Your Order</h2>
                    {orderDetails && orderDetails.order_items ? (
                        <div className="card" style={{ borderRadius: "10px" }}>
                                ...
                                {orderDetails.order_items.map((item) => (
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col-md-2 col-lg-3 g-3">
                                                    <img
                                                ...
                                                <div className="col-md-2 col-lg-3  g-3 text-center d-flex justify-content-center align-items-center">
                            ...
                            >
                                <h6 className="col-md-6 col-lg-6 d-flex align-items-center justify-content-start text-white mb-2 g-3">
                                    address : {orderDetails.shipping_address}
                                    <br />
                                    phone : {orderDetails.phone_number}
                                </h6>
                                <h5 className="col-md-6 col-lg-6 d-flex align-items-center justify-content-end text-white text-uppercase mb-0">
                                    Total paid:{" "}
